...
public class ArtistService {
    ...
    public Artist addArtist(Artist artist){
        if (artistRepository.existsByArtistName(artist.getArtistName())) {
            log.error("Artist {} already exists", artist.getArtistName());
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Artist " + artist.getArtistName() + " already exists");
        }
